...
```javascript
import isAccessorArray from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-accessor-array@v0.2.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/assert-is-accessor-array/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/assert-is-accessor-array/actions/workflows/test.yml?query=branch:v0.2.1
